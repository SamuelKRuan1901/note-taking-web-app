...
const DesktopHeader = () => {
  ...
  return (
    <div className='w-auto h-20 flex items-center justify-between px-6 border-b border-slate-400'>
      ...
      <div className='flex items-center justify-center gap-4 pr-4'>
        ...
        <div
          className='hover:bg-slate-300 p-2 rounded-md cursor-pointer transition-all duration-300'
